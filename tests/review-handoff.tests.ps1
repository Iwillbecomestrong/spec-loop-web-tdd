...
try {
    ...
    Assert-True ($reviewSectionIndex -ge 0 -and $noGitRequirementIndex -gt $reviewSectionIndex -and $verificationSectionIndex -gt $noGitRequirementIndex) 'No-Git snapshot requirements must be documented inside the review stage.'
